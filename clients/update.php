...
<div class="art-layout-wrapper">
                <div class="art-content-layout">
                    <div class="art-content-layout-row">
                        <div class="art-layout-cell art-content"><article class="art-post art-article">
                                <h2 class="art-postheader">Update Client</h2>
	...
	$sql = "UPDATE `doctors` SET `names`='".$name."',`cell no`='".$cell."',`email`='".$email."',`surname_intial`='".$surname."' WHERE `pk`='".$id."'";
   ...
   $res = mysqli_query($conn,$sql);
          ...
          while($row = mysqli_fetch_array($res)){
				...
				<span style="font-size: 18px; ">Surname & Initials</span></td>
				<td style="width: 80%; border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px; ">
				<input name="surname" value="'.$row['surname_intial'].' " type="text" require><br></td></tr><tr>
				...
				<td style="width: 80%; border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px; ">
				<input  name="name"  value="'.$row['names'].'" type="text"><br></td></tr>
        ...
        <tr>
				...
				<td style="width: 80%; border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px; ">
				<input name="cell"  value="'.$row['cell no'].'" type="text"><br></td>
				</tr><tr>
				<td style="width: 20%; border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px; ">
				<span style="font-size: 18px; ">Email</span><br></td>
				<td style="width: 80%; border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px; ">
				<input name="email" value="'.$row['email'].'" type="text"><br></td></tr><tr>
				<td style="width: 20%; border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px; ">
				<span style="font-size: 18px;"><br></span></td>
				<td style="width: 80%; border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px; ">


				<input type="submit" width="100px" name="submit" value="Update Client" class="art-button">
